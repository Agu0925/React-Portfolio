    ...
    <>
      <div className="fixed-top container d-none d-md-block">
        <div className="row">
          ...
          <div className="text-end col m-auto">
            <a className="btn btn-primary py-md-3" href="http://127.0.0.1:5173/Contacto">Contactame</a>
          </div>
          <div className="text-end m-auto">
            <a className="btn btn-primary py-md-3" href="http://127.0.0.1:5173/Proyectos">Mis Proyectos</a>
          </div>
        </div>
      </div>
      <div className="d-md-none text-center">
        <div className="row">
          ...
          <div className="col-4 m-auto">
            <a className="btn btn-primary py-3" href="http://127.0.0.1:5173/Contacto">Contactame</a>
          </div>
          <div className="col-4 m-auto">
            <a className="btn btn-primary py-3" href="http://127.0.0.1:5173/Proyectos">Proyectos</a>
          </div>
        </div>
      </div>
    </>
...
export const Botones2 = () => {
  return (
    <div className="text-center">
      <div className="row">
        <div className="col-4 m-auto">
          <a className="btn btn-primary py-3 px-4" href="http://127.0.0.1:5173/">Inicio</a>
        </div>
        <div className="col-4 m-auto">
          <a className="btn" href="https://www.linkedin.com/in/agustin-ahlers/" target="_blank">
        ...
        <div className="col-4 m-auto">
          <a className="btn btn-primary py-3" href="http://127.0.0.1:5173/Contacto">Contacto</a>
        </div>
      </div>
    </div>
  )
